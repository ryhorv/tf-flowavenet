...
from tensorflow.python.keras.layers.convolutional import Conv2DTranspose as Conv2DT
    ...
    def build(self, input_shape):
        ...
        if self.weight_norm:
            self.g = self.add_weight(
                    name="wn/g",
                    shape=(self.filters,),
#                     initializer=init_ops.VarianceScaling(distribution="uniform"),
